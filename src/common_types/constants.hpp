...
inline constexpr uint32_t drawing_rectangle = 2;

inline constexpr uint32_t border_size = 6;
inline constexpr uint32_t inner_color = 7;
inline constexpr uint32_t subrect = 10;

inline constexpr uint32_t enabled = 4;
inline constexpr uint32_t disabled = 3;
inline constexpr uint32_t border_filter = 0;
inline constexpr uint32_t filter = 1;
inline constexpr uint32_t no_filter = 2;
inline constexpr uint32_t sub_sprite = 5;
inline constexpr uint32_t use_mask = 6;
inline constexpr uint32_t progress_bar = 7;
inline constexpr uint32_t frame_stretch = 8;
inline constexpr uint32_t piechart = 9;
inline constexpr uint32_t barchart = 10;
inline constexpr uint32_t linegraph = 11;
inline constexpr uint32_t tint = 12;
inline constexpr uint32_t interactable = 13;
inline constexpr uint32_t interactable_disabled = 14;
inline constexpr uint32_t subsprite_b = 15;
inline constexpr uint32_t alternate_tint = 16;
inline constexpr uint32_t linegraph_color = 17;
inline constexpr uint32_t transparent_color = 18;
inline constexpr uint32_t solid_color = 19;
inline constexpr uint32_t alpha_color = 20;
inline constexpr uint32_t subsprite_c = 21;
inline constexpr uint32_t linegraph_acolor = 22;
inline constexpr uint32_t stripchart = 23;
inline constexpr uint32_t triangle_strip = 24;
inline constexpr uint32_t border_repeat = 25;
inline constexpr uint32_t corner_repeat = 26;
} // namespace parameters
}
