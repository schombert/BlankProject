...
directory get_or_create_settings_directory() {
	native_string path = native_string(getenv("HOME")) + "/.local/share/" + NATIVE_PROGRAM_NAME + "/settings/";
...
directory get_or_create_save_game_directory(native_string mod_dir) {
	native_string path = native_string(getenv("HOME")) + "/.local/share/" + NATIVE_PROGRAM_NAME +  "/saves/";
	if(mod_dir.length() > 0) {
...
directory get_or_create_root_documents() {
	native_string path = native_string(getenv("HOME")) + "/.local/share/" + NATIVE_PROGRAM_NAME + "/";
	make_directories(path);
...
directory get_or_create_templates_directory() {
	native_string path = native_string(getenv("HOME")) + "/.local/share/" + NATIVE_PROGRAM_NAME + "/templates/";
	make_directories(path);

	return directory(nullptr, path);
}
directory get_or_create_gamerules_directory() {
	native_string path = native_string(getenv("HOME")) + "/.local/share/" + NATIVE_PROGRAM_NAME + "/gamerules/";
	make_directories(path);
...
directory get_or_create_oos_directory() {
	native_string path = native_string(getenv("HOME")) + "/.local/share/" + NATIVE_PROGRAM_NAME + "/oos/";
	make_directories(path);
...
directory get_or_create_data_dumps_directory() {
	native_string path = native_string(getenv("HOME")) + "/.local/share/" + NATIVE_PROGRAM_NAME + "/data_dumps/";
	make_directories(path);
...
directory get_or_create_scenario_directory() {
	native_string path = native_string(getenv("HOME")) + "/.local/share/" + NATIVE_PROGRAM_NAME + "/scenarios/";
	make_directories(path);
